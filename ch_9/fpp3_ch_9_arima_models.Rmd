...
![Source: What is stationarity? https://youtu.be/aIdTGKjQWjA ](../img/stationary_trend_seasonality.jpg){heigth="1000px," width="800px"}
...
![Source: textbook Chapter 9.1](../img/unit_root_tests.png){heigth="1000px," width="800px"}
